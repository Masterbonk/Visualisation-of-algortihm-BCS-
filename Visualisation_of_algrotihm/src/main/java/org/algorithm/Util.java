...
public class Util {
    ...
    public static void Make_UI(PApplet _sketch, int _button_height){
        ...
        Ui.add_Button("heuristic",(_sketch.displayWidth)/9f*8f, _button_height*4+_button_height/10f, _sketch.width/9f, _button_height-_button_height/10f,"Heuristic", Heuristic_Button.class, false, display_button);

        Ui.add_Button("PQ_display",(_sketch.displayWidth)/9f*8f, _button_height*5+_button_height/10f, _sketch.displayWidth/9f, _button_height-_button_height/10f,"Priority queue", PQueue_Button.class, false, display_button);
