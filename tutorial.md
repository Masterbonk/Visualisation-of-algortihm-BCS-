...
Now either the pause button or forward button can be pressed. When unpausing the entire algorithm is run, and the start flag moves to the goal flag. The forward button steps through the algorithm step by step. In the beginning nothing changes, because nodes are being put in the priority queue and estimated. In order to see these specific changes, Display Q.
<br/><br/>
...
<img width="169" height="48" alt="image" src="https://github.com/user-attachments/assets/7aa00c78-84d0-43dd-b9be-baf8fa6ed9f3" />
